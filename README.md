...
Based on [hogwarts-legacy-save-convertor](https://github.com/NativeSmell/hogwarts-legacy-save-convertor) by NativeSmell, this simple Command Line utility takes the guess work out of locating folders by automatically locating the GamePass Hogwarts Legacy save folder, converting the save files to a Steam friendly format, and then automatically (after confirmation by the user) migrates the saves from GamePass to Steam.
